...
@WebServlet(name = "ServletInregistrare", urlPatterns = {"/ServletInregistrare"})
public class ServletInregistrare extends HttpServlet {
    @EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            utilizator.adaugaUtilizator(nume_de_utilizator,parola,email,nume,prenume);
